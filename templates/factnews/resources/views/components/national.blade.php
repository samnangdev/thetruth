<div class="tab01 p-b-20">
    <div class="tab01-head how2 how2-cl1 bocl12 flex-s-c m-r-10 m-r-0-sr991" style="background-color: #ffffff;">
        <!-- Brand tab -->
        <h3 class="f1-m-2 cl12 tab01-title text-danger">
            ព័ត៌មានជាតិ
        </h3>
        <!-- Nav tabs -->
        <ul class="nav nav-tabs" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#tab1-2" role="tab">នយោបាយ</a>
            </li>

            <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#tab1-3" role="tab">បទយកការណ៍</a>
            </li>
