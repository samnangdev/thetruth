...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('client/fonts/fontawesome-5.0.8/css/fontawesome-all.min.css') }}">
    <!--===============================================================================================-->
    <link rel="stylesheet" type="text/css"
    ...
    <!-- Optional if needed: <link rel="stylesheet" type="text/css" href="{{ asset('client/css/carousel.css') }}"> -->
    <!--===============================================================================================-->
    {{-- Google font library --}}
        ...
        <div class="container-menu-desktop">
                ...
                <div class="content-topbar container h-100">
                    <div class="left-topbar">
                        <span class="left-topbar-item flex-wr-s-c">
                            ...
                            <img class="m-b-1 m-rl-8" src="{{ asset('client/images/icons/icon-night.') }}png"
                                alt="IMG">
                        ...
                        <a href="{{ route('admin.home') }}" class="left-topbar-item">
                            Log in
                        </a>
                    </div>
            ...
            <div class="wrap-header-mobile">
                ...
                <div class="logo-mobile">
                    <a href="index.html"><img src="{{ asset('client/images/logo_1.png') }}" alt="IMG-LOGO"></a>
                </div>
            ...
            <div class="wrap-logo container">
                <!-- Logo desktop -->
                <div class="logo">
                    <a href="/"><img src="{{ asset('client/images/logo_1.png') }}" alt="LOGO"></a>
                </div>
                ...
                <div class="main-nav">
                    ...
                    <nav class="menu-desktop">
                        <a class="logo-stick" href="index.html">
                            <img src="{{ asset('client/images/logo_1.png') }}" alt="LOGO">
                        </a>
                        <ul class="main-menu">
                            <style>
                                .add-font {
                ...
                <div class="row">
                    <div class="col-lg-4 p-b-20 mt-4">
                        <div class="size-h-3 flex-s-c">
                            <a href="index.html">
                                <img class="max-s-full" src="{{ asset('client/images/logo_1.png') }}"
                                    alt="LOGO">
                            </a>
                        </div>
                        ...
                        <ul>
                            <li class="flex-wr-sb-s p-b-20">
                                <a href="#" class="size-w-4 wrap-pic-w hov1 trans-03">
                                    <img src="{{ asset('client/images/popular-post-01.j') }}pg" alt="IMG">
                                </a>
                            ...
                            <li class="flex-wr-sb-s p-b-20">
                                <a href="#" class="size-w-4 wrap-pic-w hov1 trans-03">
                                    <img src="{{ asset('client/images/popular-post-02.j') }}pg" alt="IMG">
                                </a>
                            ...
                            <li class="flex-wr-sb-s p-b-20">
                                <a href="#" class="size-w-4 wrap-pic-w hov1 trans-03">
                                    <img src="{{ asset('client/images/popular-post-03.j') }}pg" alt="IMG">
                                </a>
