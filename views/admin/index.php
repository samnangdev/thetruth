<?php
    ...
    $title = "The TRUTH - Admin";

    $dashboardController = new DashboardController();
    $userCount= $dashboardController ->userCount();
    $articleCount= $dashboardController ->articleCount();
    $categoryCount= $dashboardController ->categoryCount();
?>
<div class="row">
  <div class="col-lg-8 mb-4 order-0">
    <div class="card">
      <div class="d-flex align-items-end row">
        <div class="col-sm-7">
          <div class="card-body">
            <h5 class="card-title text-color">Welcome back, Admin! 🎉</h5>
            <p class="mb-4">
      ...
      <div class="col-lg-6 col-md-12 col-6 mb-4">
        <div class="card">
          <div class="card-body">
            ...
            <span>Reader</span>
            <h3 class="card-title text-nowrap mb-1">523423</h3>
      ...
      <div class="col-6 mb-4">
        <div class="card">
          <div class="card-body">
            ...
            <h3 class="card-title text-nowrap mb-2"><?php echo $articleCount; ?></h3>
      ...
      <div class="col-6 mb-4">
        <div class="card">
          <div class="card-body">
            ...
            <h3 class="card-title mb-2"><?php echo $categoryCount ?></h3>
