                                    ...
                                    <div class="wpb_wrapper">
                                        <div class="td_block_wrap td_block_title tdi_60 td-pb-border-top home-title-heading td_block_template_8 td-fix-index" data-td-block-uid="tdi_60">
                                            ...
                                            <div class="td-block-title-wrap">
                                                <h4 class="td-block-title"><a href="blog.php?id=65">សង្គមនិងវប្បធម៌</a></h4>
                                            </div>
                                        </div>
                                                                        ...
                                                                        <div id="tdi_68" class="td_block_inner td-mc1-wrap">
                                                                            <div class="td_module_flex td_module_flex_1 td_module_wrap td-animation-stack td-cpt-post">
                                                                                <div class="td-module-container td-category-pos-">
                                                                                    <div class="td-image-container">
                                                                                        <div class="td-module-thumb"><a href="article.php?id=<?php echo $row['ID']; ?>" rel="bookmark" class="td-image-wrap " title="title="<?php echo $row['TITLE']; ?>""><span class="entry-thumb td-thumb-css td-animation-stack-type1-1" data-type="css_image" data-img-url="<?php echo BASE_URL . 'storage/uploads/article/' . htmlspecialchars($row['IMAGE_URL']); ?>"></span></a></div>
                                                                                    </div>
                                                                                    <div class="td-module-meta-info">
                                                                                        <h3 class="entry-title td-module-title"><a href="article.php?id=<?php echo $row['ID']; ?>" rel="bookmark" title="title="<?php echo $row['TITLE']; ?>""><?php echo $row['TITLE'] ?></a></h3>
                                                                                        <div class="td-excerpt"><?php echo $content ?></div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
