...
<div class="tab01 p-b-20">
    <div class="tab01-head how2 how2-cl1 bocl12 flex-s-c m-r-10 m-r-0-sr991" style="background-color: #ffffff;">
        ...
        <ul class="nav nav-tabs" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link koulen" data-toggle="tab" href="#tab1-2" role="tab">នយោបាយ</a>
            </li>

            <li class="nav-item">
                <a class="nav-link koulen" data-toggle="tab" href="#tab1-3" role="tab">បទយកការណ៍</a>
            </li>
            <li class="nav-item">
                <a class="nav-link koulen" data-toggle="tab" href="#tab1-4" role="tab">បទយកការណ៍</a>
            </li>
            <!-- <li class="nav-item">
                <a class="nav-link koulen" data-toggle="tab" href="#tab1-4" role="tab">Music</a>
            </li>
    
            <li class="nav-item">
                <a class="nav-link koulen" data-toggle="tab" href="#tab1-5" role="tab">Games</a>
            </li> -->
                ...
                <?php foreach ($rows as $row): ?>
                    ...
                    <?php if ($count == 0): ?>
                        ...
                        <div class="flex-wr-sb-s m-b-30">
                            ...
                            <div class="size-w-2">
                                <h5 class="p-b-4">
                                    <a href="blog-detail-01.html" class="btb f1-s-5 btb cl3 hov-cl10 trans-03">
                                        <?php echo $row["TITLE"] ?>
                                    </a>
                                </h5>
                                <span class="cl8">
