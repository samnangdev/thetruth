...
<div class="col-md-10 col-lg-8 p-b-20">
    <div class="how2 how2-cl1 flex-s-c m-r-10 m-r-0-sr991" style="background-color: #ffffff;">
        <h3 class="f1-m-2 cl12 tab01-title">
            បច្ចេកវិទ្យា
        </h3>
        {{-- <ul class="nav nav-tabs" role="tablist">
                    </ul>
                    <a href="category-01.html" class="tab01-link f1-s-1 cl9 hov-cl10 trans-03 text-end">
                        បន្ថែម
