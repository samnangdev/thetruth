<nav class="layout-navbar container-xxl navbar navbar-expand-xl navbar-detached align-items-center bg-navbar-theme"
    ...
    <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
        ...
        <a href="?lang=en" style="color: black" class="d-flex align-items-center">
                        <img class="rounded" width="40px" src="<?php echo BASE_URL; ?>public/admin/assets/img/icons/kh.png" alt="English Flag">
            ...
            <!-- <li class="nav-item lh-1 me-3">
                <div class="btn-group ">
                    <button type="button" class="btn btn-danger btn-sm dropdown-toggle hide-arrow"
            ...
            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar avatar-online">
                                <img src="https://img.freepik.com/premium-vector/user-profile-icon-vector-9_666870-1776.jpg" alt class="w-px-40 h-auto rounded-circle" />
                        ...
                        <a class="dropdown-item" href="#">
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    ...
                                    <small class="text-muted"><?php echo  $_SESSION['user_type_name']  ?></small>
                                </div>
                            </div>
                        </a>
                    </li>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-sm btn-danger" href="<?php echo BASE_URL; ?>controllers/auth/LogoutController.php">Logout</a>
                </div>
            </div>
        </div>
    </div>
